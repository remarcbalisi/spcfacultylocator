            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <?php if( old('name') ): ?>
                        <form class="" action="<?php echo e(route('admin::faculty.update', ['username'=>Auth::user()->username, 'id'=>$user->id])); ?>" method="post">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="device_id" type="text" value="<?php echo e(old('device_id')); ?>" class="form-control">
                        ...
                        <form class="" action="<?php echo e(route('admin::faculty.update', ['username'=>Auth::user()->username, 'id'=>$user->id])); ?>" method="post">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="device_id" type="text" value="<?php echo e($user->device_id); ?>" class="form-control">
                                            <label class="form-label">Device id</label>
                                        </div>
                                    </div>
                                </div>
